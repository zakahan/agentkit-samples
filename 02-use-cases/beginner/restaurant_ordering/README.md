...
| 组件 | 描述 |
| - | - |
| **Agent 服务** | [agent.py](https://github.com/bytedance/agentkit-samples/blob/main/02-use-cases/beginner/restaurant_ordering/agent.py#L82-L117) - order_agent，点餐助手 |
| **测试脚本** | [main.py](https://github.com/bytedance/agentkit-samples/blob/main/02-use-cases/beginner/restaurant_ordering/main.py) - 完整的点餐流程演示 |
...
**异步工具定义**（[agent.py](https://github.com/bytedance/agentkit-samples/blob/main/02-use-cases/beginner/restaurant_ordering/agent.py#L52-L79)）：
...
**Agent 配置与并行调用**（[agent.py](https://github.com/bytedance/agentkit-samples/blob/main/02-use-cases/beginner/restaurant_ordering/agent.py#L82-L117)）：
...
**自定义插件**（[agent.py](https://github.com/bytedance/agentkit-samples/blob/main/02-use-cases/beginner/restaurant_ordering/agent.py#L120-L144)）：
...
**上下文管理配置**（[agent.py](https://github.com/bytedance/agentkit-samples/blob/main/02-use-cases/beginner/restaurant_ordering/agent.py#L151-L167)）：
