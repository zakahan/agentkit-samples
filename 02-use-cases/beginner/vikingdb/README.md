...
| 组件 | 描述 |
| - | - |
| **Agent 服务** | [agent.py](https://github.com/bytedance/agentkit-samples/blob/main/02-use-cases/beginner/vikingdb/agent.py) - 主应用程序，集成 KnowledgeBase 和 VikingDB |
| **知识库** | VikingDB 向量数据库，存储文档向量索引 |
| **文档源** | tech.txt（技术文档）、products.txt（产品信息） |
| **项目配置** | [pyproject.toml](https://github.com/bytedance/agentkit-samples/blob/main/02-use-cases/beginner/vikingdb/pyproject.toml) - 依赖管理（uv 工具） |
| **短期记忆** | 维护会话上下文 |

### 代码特点

**知识库创建**（[agent.py](https://github.com/bytedance/agentkit-samples/blob/main/02-use-cases/beginner/vikingdb/agent.py#L22-L29)）:
...
**Agent 配置**（[agent.py](https://github.com/bytedance/agentkit-samples/blob/main/02-use-cases/beginner/vikingdb/agent.py#L31-L36)）：
...
1. **[VikingMem](https://github.com/bytedance/agentkit-samples/tree/main/02-use-cases/beginner/vikingmem/README.md)** - 使用 VikingDB 实现长期记忆
...
4. **[Travel Concierge](https://github.com/bytedance/agentkit-samples/tree/main/02-use-cases/beginner/travel_concierge/README.md)** - 使用 Web 搜索工具规划旅行
