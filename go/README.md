...
| **名称**                                                                                                                    | **难度** | **描述**                                                             |
|---------------------------------------------------------------------------------------------------------------------------| - |--------------------------------------------------------------------|
| [`llm_auditor`](https://github.com/bytedance/agentkit-samples/tree/main/go/02-use-cases/llm_auditor)               | ![label](https://img.shields.io/badge/%E5%85%A5%E9%97%A8-E6E6FA) | 入门级对话智能体，展示如何创建一个具备短期记忆能力的基础 AI Agent                              |
