...
| **Prompts** | [prompts.py](https://github.com/bytedance/agentkit-samples/blob/main/python/01-tutorials/01-agentkit-runtime/multi_agents/prompts.py) - 各 Agent 的系统指令 |
| **测试客户端** | [client.py](https://github.com/bytedance/agentkit-samples/blob/main/python/01-tutorials/01-agentkit-runtime/multi_agents/client.py) - SSE 流式调用客户端 |

### 代码特点

**层级 Agent 定义**（[agent.py](https://github.com/bytedance/agentkit-samples/blob/main/python/01-tutorials/01-agentkit-runtime/multi_agents/agent.py#L11-L22)）：
...
**顺序执行 Agent**（[sub_agents/sequential_agent.py](https://github.com/bytedance/agentkit-samples/blob/main/python/01-tutorials/01-agentkit-runtime/multi_agents/sub_agents/sequential_agent.py#L10-L15)）：
...
**并行执行 Agent**（[sub_agents/parallel_agent.py](https://github.com/bytedance/agentkit-samples/blob/main/python/01-tutorials/01-agentkit-runtime/multi_agents/sub_agents/parallel_agent.py#L19-L24)）：
...
**循环优化 Agent**（[sub_agents/loop_agent.py](https://github.com/bytedance/agentkit-samples/blob/main/python/01-tutorials/01-agentkit-runtime/multi_agents/sub_agents/loop_agent.py#L24-L31)）：
...
```bash
# 进入项目目录
cd python/01-tutorials/01-agentkit-runtime/multi_agents
```
...
**Web 搜索工具**（[sub_agents/parallel_agent.py](https://github.com/bytedance/agentkit-samples/blob/main/python/01-tutorials/01-agentkit-runtime/multi_agents/sub_agents/parallel_agent.py#L12-L17)）：
...
**退出循环工具**（[sub_agents/loop_agent.py](https://github.com/bytedance/agentkit-samples/blob/main/python/01-tutorials/01-agentkit-runtime/multi_agents/sub_agents/loop_agent.py#L18-L23)）：
