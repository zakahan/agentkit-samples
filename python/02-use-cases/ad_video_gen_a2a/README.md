...
cd python/02-use-cases/ad_video_gen_a2a
...
# 启动 market-agent
cd python/02-use-cases/ad_video_gen_a2a/app/market-agent/src
python -m uvicorn app:app --host 127.0.0.1 --port 8000 --loop asyncio

# 启动 director-agent
cd python/02-use-cases/ad_video_gen_a2a/app/director-agent/src
python -m uvicorn app:app --host 127.0.0.1 --port 8001 --loop asyncio

# 启动 evaluate-agent
cd python/02-use-cases/ad_video_gen_a2a/app/evaluate-agent/src
python -m uvicorn app:app --host 127.0.0.1 --port 8002 --loop asyncio

# 启动 release-agent
cd python/02-use-cases/ad_video_gen_a2a/app/release-agent/src
python -m uvicorn app:app --host 127.0.0.1 --port 8003 --loop asyncio

# 最后启动 multimedia-agent
cd python/02-use-cases/ad_video_gen_a2a/app/multimedia-agent/src
python -m uvicorn server:app --host 127.0.0.1 --port 8004 --loop asyncio

# 启动 short_link 服务
cd python/02-use-cases/ad_video_gen_a2a/app/short_link
