...
def main() -> None:
    parser = argparse.ArgumentParser(description="Resize image via TOS process=image/resize")
    ...
    parser.add_argument("--w", dest="width", type=int, default=None, help="Target width")
    parser.add_argument("--h", dest="height", type=int, default=None, help="Target height")
