...
| ProjectName | string | 否 | default | **知识库所属项目，获取方式参见文档**[API 接入与技术支持](/c8p1dfoq/y97x844a) <br> 若不指定该字段，则在 default 项目下操作。 <br> 若需要操作指定项目下的知识库，需正确配置该字段。 |
...
本示例演示了知识库 Go SDK 中 DeletePoint 函数的基础使用方法，通过指定知识库名称和切片 ID 实现切片删除，使用前需配置 API Key 鉴权参数。
```Go
package main
