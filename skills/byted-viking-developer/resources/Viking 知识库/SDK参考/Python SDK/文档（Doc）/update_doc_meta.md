# 概述
update_doc_meta 用于更新知识库上文档信息，文档 meta 信息更新会自动触发索引数据更新。
# **请求参数**
...
本示例演示了知识库 Python SDK 中 UpdateDocMeta 函数的基础使用方法，通过指定知识库名称、文档 ID 和元数据信息（字段名、类型、值）修改文档元数据，使用前需配置 API Key 鉴权参数。
```Python
import os
