...
| * EventCount | Int | 当前 Collection 事件记忆数量。 |
| * ProfileCount | Int | 当前 Collection 画像记忆数量。 |
...
memory_collection_info_request = volcenginesdkvikingdb.MemoryCollectionInfoRequest(
    collection_name="your_collection_name",
    project_name="default"
)

try:
    rsp = api_instance.memory_collection_info(memory_collection_info_request)
    print(f"collection_name: {rsp.name}")
    print(f"collection_type: {rsp.collection_type}")
    print(f"created_at: {rsp.created_at}")
    print(f"pipeline_config: {rsp.pipeline_config}")
