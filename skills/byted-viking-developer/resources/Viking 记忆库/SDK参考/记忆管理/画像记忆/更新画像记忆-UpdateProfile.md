...
| memory_info <br>  | Object <br>  | 否 | 画像记忆的内容。对于内置画像sys_profile_v1只有user_profile；对于自定义画像，按照自定义的属性字段展示。 <br> **需要注意的是，其格式必须遵循在记忆库中已定义的格式。如：** <br>  <br> * 内置画像sys_profile_v1： <br>  <br> { <br> "user_profile": "### 基础信息 <br>             - 性别 女/年龄 28/家乡 广州/职业 产品经理" <br> } <br>  <br> * 自定义画像： <br>  <br> { <br> "knowledge_point_name": "math", <br> "rating_score_max": 100 <br> } |
...
# 更新用户画像
result = collection.update_profile(
    profile_id="xxxxxxx",
    memory_info={
        "兴趣偏好": "马拉松"
    }
